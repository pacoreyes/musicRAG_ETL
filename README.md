...
Figure 1.
![Dagster Assets defining the ETL Pipeline](https://github.com/pacoreyes/musicRAG_ETL/blob/master/docs/dagster_graph.png?raw=true "Dagster Assets defining the ETL Pipeline")

...
from music_rag_etl.assets.transformation.artist_index_cleaning_assets import deduplicate_artists
from music_rag_etl.settings import DATA_DIR

class TestArtistIndexCleaningAssets(unittest.TestCase):

    @patch("music_rag_etl.assets.transformation.artist_index_cleaning_assets.pl.scan_ndjson")
    def test_deduplicate_artists(self, mock_scan_ndjson):
        ...
        data = {
            ...
            "inception": ["2000-01-01", "1995-01-01", "1990-01-01", "2005-01-01", "1998-01-01"],
        }
